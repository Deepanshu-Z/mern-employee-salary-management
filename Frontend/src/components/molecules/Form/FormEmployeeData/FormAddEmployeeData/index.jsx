...
const FormAddEmployeeData = () => {
    ...
    const submitEmployeeData = (e) => {
        ...
        newFormData.append('national_id', national_id);
        newFormData.append('employee_name', nameEmployee);
        ...
        newFormData.append('join_date', tanggalMasuk);
        newFormData.append('status', status);
        newFormData.append('access_role', access_role);
                        ...
                        <form onSubmit={submitEmployeeData}>
                            <div className='p-6.5'>
                                <div className='mb-4.5 flex flex-col gap-6 xl:flex-row'>
                                    <div className='w-full xl:w-1/2'>
                                        ...
                                        <input
                                            ...
                                            required
                                            placeholder='Masukkan nomor national_id'
                                    ...
                                    <div className='w-full xl:w-1/2'>
                                        ...
                                        <div className='relative z-20 bg-transparent dark:bg-form-input'>
                                            <select className='relative z-20 w-full appearance-none rounded border border-stroke bg-transparent py-3 px-5 outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary'
                                                ...
                                                required={true}
                                            >
                                                <option value='' disabled={true}>Select jenis kelamin</option>
                                ...
                                <div className="mb-4.5 flex flex-col gap-6 xl:flex-row">
                                    ...
                                    <div className='w-full xl:w-1/2'>
                                        <label className='mb-2.5 block text-black dark:text-white'>
                                            Date Masuk <span className='text-meta-1'>*</span>
                                        </label>
                                        <input
                                            type='date'
                                            id='tanggalMasuk'
                                    ...
                                    <div className='w-full xl:w-1/2'>
                                        ...
                                        <div className='relative z-20 bg-transparent dark:bg-form-input'>
                                            <select className='relative z-20 w-full appearance-none rounded border border-stroke bg-transparent py-3 px-5 outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary'
                                                ...
                                                required={true}
                                            >
                                                <option value='' disabled={true}>Select hak akses</option>
